...
bool Game::Init() {
    ...
    if(!Menu.loadFiles("Assets" + "arial.ttf",  "Assets" + "MenuBackGround.png", "Assets" + "HowToPlay.jpg")){
        return false;
    }
    if(!Stage.init("Assets" + "Back.png","Assets" + "Arial.ttf", "Assets" + "stick.png", "Assets" + "Player.png")){
        return false;
